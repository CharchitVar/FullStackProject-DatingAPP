...
export class MessagesResolver implements Resolve<Message[]>{
    ...
    constructor(private userService: UserService,private authService: AuthServiceService, private router: Router, private alertify: AlertifyService) {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<Message[]>{
        return this.userService.getMessages(this.authService.decodedToken.nameid,this.pageNumber,
            ...
            catchError(error => {
                this.alertify.error('Problem Retriving In Messages');
